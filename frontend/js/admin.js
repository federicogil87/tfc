                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <button class="action-btn edit edit-user" data-id="${
                                              user.id
                                            }">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button class="action-btn delete delete-user" data-id="${
                                              user.id
                                            }">
                      ...
                      .map(
                        ...
                        <div class="model-card">
                            ...
                            <div class="model-card-info">
                                ...
                                <p><span class="label">Tipo de datos:</span> ${
                                  model.metadata.data_type === "test"
                                    ? "Prueba"
                                    : "Real"
                                }</p>
                                <p><span class="label">Creado por:</span> ${
                                  model.metadata.created_by || "Desconocido"
                                }</p>
                            </div>
                            <div class="model-card-footer">
                                <span class="model-card-date">${formatDate(
                                  model.created_at
                                )}</span>
                                <button class="btn btn-danger btn-sm delete-cnn-model" data-model="${
                                  model.id
                                }">
                      ...
                      .map(
                        ...
                        <div class="model-card">
                            <div class="model-card-header">
                                ...
                                <span class="model-card-type">${
                                  model.metadata.algorithm || "Tabular"
                                }</span>
                            </div>
                            <div class="model-card-info">
                                <p><span class="label">Algoritmo:</span> ${
                            ...
                            <div class="model-card-footer">
                                ...
                                <button class="btn btn-danger btn-sm delete-tabular-model" data-model="${
                                  model.id
                                }">
                                    <i class="fas fa-trash-alt"></i> Eliminar
                                </button>
...
function confirmDeleteModel(modelType, modelName) {
  ...
  document.getElementById(
    "confirm-title"
  ).textContent = `Eliminar Modelo ${modelType}`;
  document.getElementById(
    "confirm-message"
  ).textContent = `¿Estás seguro de que deseas eliminar el modelo "${modelName}"? Esta acción no se puede deshacer.`;
